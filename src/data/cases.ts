...
export const cases: CaseStudy[] = [
  ...
  // ═══════════════════════════════════════════════════════
  {
    ...
    thumbnail: 'https://i.ytimg.com/vi/LjlAApGIXYQ/hqdefault.jpg',
  ...
  // ═══════════════════════════════════════════════════════
  // 11b. Greenline Journey — A Beginner Learns Golf
  // ═══════════════════════════════════════════════════════
  {
    id: 'greenline-journey',
    title: 'Greenline Journey — A Beginner Learns Golf',
    industry: 'Golf',
    goal: 'Awareness',
    outputs: ['YouTube Series', 'Social Content', 'IG Reels'],
    styleDNA: ['Cinematic', 'Warm', 'Aspirational'],
    thumbnail: 'https://i.ytimg.com/vi/k1g3pGY5_FE/hqdefault.jpg',
    gradient: gradients[10],
    description: 'A long-form docuseries following a complete beginner learning golf from scratch at Greenline — from first grip to first round. Built to make the game feel reachable without flattening its craft. An episodic story about pressure, patience, and the small wins that make a player.',
    deliverables: ['Episodic YouTube Series (Ongoing)', 'Social Cutdowns', 'IG Reels Pack', 'Series Art Direction'],
    approach: [
      'Framed the series as a real journey, not a tutorial — every episode holds a milestone, a struggle, and a quiet win',
      'Shot with documentary language so learning feels like a story, not a manual',
      'Balanced intimate character work with clear coaching moments from the Greenline team',
      'Designed the format to pull in curious beginners without losing the respect of serious players',
    ],
    videoUrl: '',
    videoIds: [],
    platforms: ['YouTube', 'IG Reels', 'TikTok'],
    scale: 'Production',
    audience: 'Golf Curious Beginner',
  },
  ...
  // ═══════════════════════════════════════════════════════
  {
    ...
    thumbnail: 'https://iili.io/qvt0XFp.jpg',
  ...
  // ═══════════════════════════════════════════════════════
  {
    ...
    outputs: ['Social Content', 'IG Reels', 'Food Films'],
    styleDNA: ['Cinematic', 'Warm', 'Serious'],
    thumbnail: '/thumbnails/lim-lao-ngow.jpg',
  ...
  // ═══════════════════════════════════════════════════════
  {
    ...
    styleDNA: ['Cinematic', 'Quiet Luxury', 'Minimal'],
    thumbnail: '/thumbnails/sonle-residences.jpg',
